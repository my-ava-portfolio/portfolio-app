...
import { homePages, infoIcon, pythonIcon } from '@shared/inputs';
import { githubIcon, linkedinIcon, emailIcon } from '@shared/inputs';
import { menuIcon, helpIcon, exclamationIcon, bugIcon } from '@shared/inputs';
import { githubBugIssueUrl, githubEnhancementUrl, githubQuestionUrl } from '@shared/inputs';
import { currentYear, mainTopicsPages, imageProfile } from '@shared/inputs';
