...
import { githubIcon, linkedinIcon, printIcon, emailIcon } from '@shared/inputs';
import { navIcon, projectIcon, publishIcon, jobIcon, volunteerIcon, presIcon } from '@shared/inputs';
import { experiencesPages } from '@shared/inputs';
