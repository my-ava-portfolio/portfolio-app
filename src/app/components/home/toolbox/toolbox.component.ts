...
import { centerIcon, helpIcon, removeIcon, toolsIcon, locationIcon, lineIcon, PolygonIcon, editIcon, addIcon } from '@shared/inputs';

import { PointsSvgLayerOnLeaflet } from '@helpers/points_svg_layer';
import { Point } from '@helpers/core-geom';
