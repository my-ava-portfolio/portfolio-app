...
import { locationIcon, tagsIcon, centerIcon, trainIconUnicode, helpIcon, minWidthLandscape, imageProfile } from '@shared/inputs';
import { apiLogoUrl, currentYear } from '@shared/inputs';
import { svgActivitiesPointsLayerId, svgTripIdPrefix, legendActivities } from '@shared/inputs';

import { checkIfScreenPortraitOrientation } from '@shared/inputs';
