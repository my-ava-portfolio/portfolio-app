...
import { apiMapsUrl, minWidthLandscape } from '@shared/inputs';
...
import { pythonIcon, tagsIcon, tagIcon, chartItemIcon, mapIcon, videoItemIcon, appItemIcon, toolItemIcon, methodoIcon } from '@shared/inputs';
